...
func NewUser(svc *user.Service, ur *echo.Group) {
	...
	// description: Returns list of users. Depending on the user role requesting it, it may return all users for SuperAdmin/Admin users, all shelter users for Shelter admins, and an error for non-admin users.
	// parameters:
	// - name: limit
	//   in: query
