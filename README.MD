...
[![Go Report Card](https://goreportcard.com/badge/github.com/artistomin/gorsk)](https://goreportcard.com/report/github.com/artistomin/gorsk)
...
Previously Gorsk was built using [Gin](https://github.com/gin-gonic/gin). Gorsk using Gin is available [HERE](https://github.com/artistomin/gorsk-gin).
...
1. To use Gorsk as a starting point of a real project whose package name is something like `github.com/author/project`, move the directory `$GOPATH/github.com/artistomin/gorsk` to `$GOPATH/github.com/author/project` and do a global replacement of the string `github.com/artistomin/gorsk` with `github.com/author/project`.
