...
[![Go Report Card](https://goreportcard.com/badge/github.com/artistomin/friend4me)](https://goreportcard.com/report/github.com/artistomin/friend4me)
...
Previously Gorsk was built using [Gin](https://github.com/gin-gonic/gin). Gorsk using Gin is available [HERE](https://github.com/artistomin/friend4me-gin).
...
1. To use Gorsk as a starting point of a real project whose package name is something like `github.com/author/project`, move the directory `$GOPATH/github.com/artistomin/friend4me` to `$GOPATH/github.com/author/project` and do a global replacement of the string `github.com/artistomin/friend4me` with `github.com/author/project`.
